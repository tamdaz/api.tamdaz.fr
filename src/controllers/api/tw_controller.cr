...
class App::Controllers::API::TWController < App::Controllers::AbstractController
  ...
  # Retrieves the article of the technology watch by its ID.
  @[ARTA::Get("/{id}")]
  ...
  # Creates an article of the technology watch by its ID.
  @[ARTA::Post("/create")]
  ...
  # Updates the article of the technology watch by its ID.
  @[ARTA::Put("/{id}/update")]
  ...
  # Deletes the article of the technology watch by its ID.
